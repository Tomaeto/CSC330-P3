#!/usr/bin/sbcl --script
;;Program for iteravely calculating 10 smallest ints w/ the longest
...
(defun collatz (val)
	...
	;;Iteratively runs Collatz formula until input value reaches 1

	;;While input is not 1, runs Collatz formula and increments counter
	(setq counter 0)
	(loop
	     (progn
	          (if (= (mod val 2) 0)
